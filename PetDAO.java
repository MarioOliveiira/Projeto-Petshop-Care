...
public class PetDAO {
    ...
    public void inserir(Pet pet) {
        String sql;
        sql = "INSERT INTO Pet (nome, porte, tipo_pelo, peso, cod_animal, cod_cliente)" +
                " VALUES ('" + pet.getNome() + "', '" + pet.getPorte() + "', '" + pet.getTipo_pelo() + "', '" + pet.getPeso() + "', '" + pet.getCod_animal() + "', '" + pet.getCod_cliente() + "')";
        try {
    ...
    public ArrayList<Pet> buscar() {
        ...
        String sql, nome, porte, tipo_pelo;
        double peso;
        ...
        try {
            ...
            while (banco.rs.next()){
                ...
                Pet pet = new Pet(nome, porte, tipo_pelo, peso, cod_animal, cod_cliente);
    ...
    public void atualizar (Pet pet){
        String sql;
        sql = "UPDATE Pet SET nome = '" + pet.getNome() +
                "', porte = '" + pet.getPorte() +
